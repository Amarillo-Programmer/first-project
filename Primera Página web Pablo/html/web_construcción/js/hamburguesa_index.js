...
const deslizante=document.querySelector(".deslizador");
const girar=document.querySelector(".girar");
const nosotros=document.querySelector(".nosotros");
const ofertas=document.querySelector("#ofertas_section");
...
function aplastar() {
    ...
    deslizante.classList.toggle("aplastar");
    girar.classList.toggle("aplastar");
    nosotros.classList.toggle("aplastar");
    ofertas.classList.toggle("aplastar");
